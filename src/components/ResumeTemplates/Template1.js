  ...
  return (
    <div className="w-full flex mt-4">
      <div
        ...
        ref={templateOneRef}
      >
        <div className="flex bg-[#353535]  h-screen  text-white flex-col gap-4 p-10 basis-[35%] ">
          <div>
          ...
          <div>
            ...
            <div>{school_city}</div>
            <div>{degree}</div>
            {education_start_date && <span>{education_start_date}</span>}

            {education_end_date && <span> to {education_end_date}</span>}
